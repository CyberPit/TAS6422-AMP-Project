# 1 "lcd_driver_files/i2c-lcdlib-ceg003400.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "lcd_driver_files/i2c-lcdlib-ceg003400.c" 2
# 14 "lcd_driver_files/i2c-lcdlib-ceg003400.c"
...
# 15 "lcd_driver_files/i2c-lcdlib-ceg003400.c" 2
...
# 16 "lcd_driver_files/i2c-lcdlib-ceg003400.c" 2
...
# 12 "/Applications/microchip/xc8/v2.30/pic/include/c99/xc8debug.h" 3
...
# 18 "lcd_driver_files/i2c-lcdlib-ceg003400.c" 2
...
# 20 "lcd_driver_files/i2c-lcdlib-ceg003400.c" 2
# 1 "lcd_driver_files/../mcc_generated_files/examples/i2c1_master_example.h" 1
# 50 "lcd_driver_files/../mcc_generated_files/examples/i2c1_master_example.h"
...
# 50 "lcd_driver_files/../mcc_generated_files/examples/i2c1_master_example.h" 2


# 1 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h" 1
# 56 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
# 1 "/Applications/microchip/xc8/v2.30/pic/include/c99/stdbool.h" 1 3
# 56 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h" 2
...
# 101 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
i2c1_error_t I2C1_Open(i2c1_address_t address);
# 111 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
i2c1_error_t I2C1_Close(void);
# 123 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
...
# 142 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
void I2C1_SetTimeout(uint8_t timeOut);
# 152 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
void I2C1_SetBuffer(void *buffer, size_t bufferSize);
# 164 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
void I2C1_SetDataCompleteCallback(i2c1_callback_t cb, void *ptr);
# 174 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
void I2C1_SetWriteCollisionCallback(i2c1_callback_t cb, void *ptr);
# 184 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
void I2C1_SetAddressNackCallback(i2c1_callback_t cb, void *ptr);
# 194 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
void I2C1_SetDataNackCallback(i2c1_callback_t cb, void *ptr);
# 204 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
void I2C1_SetTimeoutCallback(i2c1_callback_t cb, void *ptr);
# 213 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
void (*MSSP1_InterruptHandler)(void);
# 222 "lcd_driver_files/../mcc_generated_files/examples/../i2c1_master.h"
void I2C1_SetInterruptHandler(void (* InterruptHandler)(void));
# 52 "lcd_driver_files/../mcc_generated_files/examples/i2c1_master_example.h" 2
...
# 21 "lcd_driver_files/i2c-lcdlib-ceg003400.c" 2
# 49 "lcd_driver_files/i2c-lcdlib-ceg003400.c"
void i2c_lcd_send_command(unsigned char data)
    {
    unsigned char upperdata, upperdata_en, lowerdata, lowerdata_en;


    upperdata = (data & 0xf0) | 0b00001000;
    upperdata_en = upperdata | 0b00000100;
    lowerdata = ((data << 4) & 0xf0) | 0b00001000 ;
    lowerdata_en = lowerdata | 0b00000100;
      I2C1_WriteNBytes(0x25, &upperdata_en,1);
     _delay((unsigned long)((1)*(4000000/4000000.0)));

     I2C1_WriteNBytes(0x25, &upperdata, 1);
     _delay((unsigned long)((1)*(4000000/4000000.0)));



    I2C1_WriteNBytes(0x25, &lowerdata_en, 1);
     _delay((unsigned long)((1)*(4000000/4000000.0)));

    I2C1_WriteNBytes(0x25, &lowerdata, 1);
     _delay((unsigned long)((1)*(4000000/4000000.0)));
...
void i2c_lcd_send_data(unsigned char data)
{
   unsigned char upperdata, upperdata_en, lowerdata, lowerdata_en;
    ...
    upperdata = (data & 0xf0) | 0b00001000 | 0b00000001;
    upperdata_en = upperdata | 0b00000100;
    lowerdata = ((data << 4) & 0xf0) | 0b00001000 | 0b00000001 ;
    lowerdata_en = lowerdata | 0b00000100;
      I2C1_WriteNBytes(0x25, &upperdata_en,1);
     _delay((unsigned long)((1)*(4000000/4000000.0)));
